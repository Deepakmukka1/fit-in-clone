  ...
  return (
    <footer className="mx-auto max-w-screen-xl grid lg:grid-cols-5 sm:grid-cols-3 grid-cols-2 gap-16 mt-10 px-12 items-start place-items-center pb-20">
      ...
      <div className="lg:order-3 order-1">
        <h3 className="text-textprimary-100 font-semibold text-sm">Account</h3>
        <ul className="mt-8 flex flex-col gap-4 text-textprimary-50 text-sm">
          <li>
      ...
      <div className="lg:order-4 order-2">
        <h3 className="text-textprimary-100 font-semibold text-sm">Company</h3>
        <ul className="mt-8 flex flex-col gap-4 text-textprimary-50 text-sm">
          <li>
      ...
      <div className="lg:order-5 order-3">
        <h3 className="text-textprimary-100 font-semibold text-sm">Resources</h3>
        <ul className="mt-8 flex flex-col gap-4 text-textprimary-50 text-sm">
          <li>
      ...
      <div className="flex flex-col gap-8 lg:gap-10 text-textprimary-100 lg:order-1 order-4">
      ...
      <div className="flex flex-col lg:gap-10 gap-4 text-textprimary-50 lg:order-2 order-5 lg:col-span-1 col-span-2">
        <h3 className="text-textprimary-100 font-semibold">Contact Us</h3>
