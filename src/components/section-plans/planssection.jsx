    ...
    >
      ...
      <div className="text-center grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-16 gap-16 justify-items-center">
        ...
        <div className="md:col-span-2 xl:col-span-1">
          <h3 className="text-2xl text-center font-semibold text-[#555555]">
            Works for anyone
          </h3>
      ...
      className="transition-all duration-[3000ms]  border-b-2 pb-1 border-[#555555] hover:border-none text-[#555555]"
      > 
