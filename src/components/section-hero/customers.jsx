  ...
  return (
    <div className="flex sm:flex-row flex-col lg:justify-normal justify-center gap-4 items-center w-full mt-4 mb-4">
      <div className="flex">
        ...
        <img
          src={Customer2}
          className="xl:w-12 xl:h-12 w-10 h-10 rounded-full -ml-5 border-gray-200 border-4"
          loading="lazy"
          alt="customers"
        />
        <img
      ...
      <div>
        <h5 className="font-semibold xl:text-lg text-sm text-textprimary">
          10,000+ <span className="text-textprimary-300">happy customers!</span>
        </h5>
      </div>
    </div>
  );
