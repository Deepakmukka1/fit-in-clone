        ...
        <form className="grid lg:grid-cols-2 grid-cols-1 gap-8 items-end text-base">
          <div className="block">
            ...
            <input
              ...
              name="fullname"
              className="md:p-3 px-2 py-1 bg-[#dee2e6] rounded-lg shadow-lg w-full"
            />
          </div>
          <div>
            ...
            <input
              ...
              className="md:p-3 px-2 py-1 text-base bg-[#dee2e6] rounded-lg shadow-lg w-full"
            />
          </div>
          <div>
            <label htmlFor="where" className="block mb-2 font-base">Where did you hear about us?</label>
            <select name="where" className="md:p-3 px-2 py-1 text-base bg-[#dee2e6] rounded-lg shadow-lg w-full">
            ...
            <button className="bg-[#9EA1A4] w-full p-3 rounded-xl text-black hover:bg-white transition-all duration-700">Sign up now</button>
        </form>
      </div>
